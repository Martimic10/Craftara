...
export default function DashboardContractQuickPage() {
  return (
    <RequireAuth>
      <main className="px-4 pb-16 pt-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl rounded-2xl border border-black/10 bg-white/85 p-8 shadow-sm">
          <h1 className="text-3xl font-semibold tracking-tight text-black">ContractQuick</h1>
          <p className="mt-3 text-black/70">Create agreements and export clean PDFs from the full tool workspace.</p>
          <Link
            href="/contractquick"
